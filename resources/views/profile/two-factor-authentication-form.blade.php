<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Dodaj dodatkowe zabezpieczenie do swojego porzez uwierzytelnianie dwuetapowe') }}
    </x-slot>

    <x-slot name="content">
        <h3 class="text-lg font-medium text-gray-900">
            @if ($this->enabled)
                {{ __('Uwierzytelnianie dwuetapowe jest aktywne') }}
            @else
                {{ __('Uwierzytelnianie dwuetapowe nie jest aktywne') }}
            @endif
        </h3>
