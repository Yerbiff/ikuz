...
<div id="alert" class="alert-toast fixed bottom-0 right-0 m-8 w-5/6 md:w-full max-w-sm" style="visibility: hidden">
    ...
    <label class="close cursor-pointer flex items-start justify-between w-full p-2 bg-green-500 h-24 rounded shadow-lg text-white" title="close" for="footertoast">
        Udało się dodać mail do newslettera
                        ...
                        <button class="navbar-toggler navbar-toggler-right" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
                            ...
                            <div class="collapse navbar-collapse" id="navbarResponsive">
                                <ul class="navbar-nav ms-auto">
                                        ...
                                        <li class="nav-item"><a class="nav-link" onclick="change()" href="#about">O nas</a></li>
...
{{--                                data-sb-form-api-token='API_TOKEN'--}}
                                ...
                                <form class="form-signup" id="contactForm"  action="/" method="POST">
                                    ...
                                    <div class="row input-group-newsletter">
                                        ...
                                        <div class="col-auto"><button class="bg-gray-800 btn text-white" id="submitButton" onclick="change()" type="submit">Powiadom mnie</button></div>
{{--                                        disabled--}}
                                    </div>
